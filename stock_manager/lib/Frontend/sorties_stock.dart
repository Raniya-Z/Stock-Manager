...
class SortiesStockPage extends StatefulWidget {
  final List<String> initialCategories;
  final List<String> initialProduits;

  const SortiesStockPage({
    super.key,
  ...
  @override
  State<SortiesStockPage> createState() => _SortiesStockPageState();
}

  class _SortiesStockPageState extends State<SortiesStockPage> {
  ...
  final TextEditingController quantiteSortieController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Sorties de stock",
            style: TextStyle(color: fond, fontWeight: FontWeight.w600, fontSize: 18)),
        centerTitle: true,
        actions: [
          Padding(
            padding: const EdgeInsets.only(right: 12),
            child: Icon(Icons.remove_circle_outline, color: fond),
          ),
        ],
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 13),
              // Quantité stock et Quantité sorties
              Row(
                children: [
                  Expanded(
                    child: TextField(
                  ...
                  Expanded(
                    child: TextField(
                      controller: quantiteSortieController,
                      cursorColor: bleu,
                      style: TextStyle(color: bleu),
                      decoration: InputDecoration(
                        labelText: "Quantité sortie",
                        labelStyle: TextStyle(color: Colors.grey[700], fontSize: 15),
                        enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: Colors.grey[400]!)),
                        focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: bleu)),
                      ),
                    ...
                    child: OutlinedButton(
                      ...
                      onPressed: () {
                        setState(() {
                          ...
                          quantiteSortieController.clear();
